...
db.trazas.find({"app_acceso":"Cliente"},{_id:0,id_usuario:1}).sort({ fecha_acceso:-1 }).limit(1)
//Listado de todas las URLs almacenadas y el número de accesos que ha tenido cada una.
db.trazas.mapReduce(function(){emit(this.url,1)},
...
db.trazas.find({ $and: [{url:"http://spotify.com"}, {tags: "ocio" }]}, { _id: 0, id_usuario: 1 })
